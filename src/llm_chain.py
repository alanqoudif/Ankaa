...
class LegalQAChain:
    ...
    def __init__(
        ...
        if os.path.exists(model_path):
            ...
            self.prompt_template = PromptTemplate(
                ...
                template="""
                You are a legal assistant specialized in Omani laws. Answer the question based ONLY on the context provided.
    ...
    def answer_question(self, question: str, context: str) -> str:
        ...
        if self.chain is None:
            return "I apologize, but the AI model is not properly initialized. Please make sure the model file exists and try again."
